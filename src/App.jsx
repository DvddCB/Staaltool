          ...
          <>
            ...
            <section style={styles.twoColumn}>
              <div style={styles.pickbonPanel}>
                ...
                {pickbonLines.length > 0 && String(currentSelectedPickerOrder?.status || "").toLowerCase() !== "gereed" && !allPickbonLinesProcessed && (
                  <div style={styles.orderReadyBox}>
                    <div>
                      <strong>Artikel picken</strong>
                      <span> Scan of verwerk eerst alle artikelregels.</span>
                    </div>
                    <button style={styles.smallScanButton} onClick={startScanner}>Artikel picken</button>
                  </div>
                )}

                {allPickbonLinesProcessed && String(currentSelectedPickerOrder?.status || "").toLowerCase() !== "gereed" && (
                  <div style={styles.orderReadyBox}>
                    <div>
                      <strong>Alle regels zijn gepickt.</strong>
                      <span> Zet nu de volledige pickbon op verwerkt.</span>
                    </div>
                    <button style={styles.finishOrderButton} onClick={requestFinishOrder}>Pickbon verwerken</button>
                  </div>
                )}
                      ...
                      <div key={line.id} style={line.processed ? styles.pickbonLineDone : styles.pickbonLine} className="pickbon-line-responsive">
                        ...
                        <div style={styles.pickbonLineControls} className="pickbon-controls-responsive">
                          ...
                          {line.processed ? (
                            ...
                            <button style={styles.smallDarkButton} onClick={() => requestProcessLine(line.id)}>Pickbon verwerken</button>
                          ) : (
