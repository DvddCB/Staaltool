...
export default function App() {
  ...
  const isReception = normalizeRoleValue(userRole) === "receptie";
        ...
        <header style={styles.header} className="app-header-responsive">
          ...
          <div style={styles.headerActions} className="app-actions-responsive">
            ...
            <button style={styles.logoutButton} onClick={logout}>Uitloggen</button>
                ...
                {(isAdmin || isReception) && (selectedOrder?.pakbon_url || selectedOrder?.stickerbon_url) && (
                  <div style={styles.pdfButtonRow}>
                    {selectedOrder?.pakbon_url && (
                      <button
                        style={styles.pdfButton}
                        onClick={() => window.open(selectedOrder.pakbon_url, "_blank")}
                      >
                        Pakbon openen
                      </button>
                    )}

                    {selectedOrder?.stickerbon_url && (
                      <button
                        style={styles.pdfButton}
                        onClick={() => window.open(selectedOrder.stickerbon_url, "_blank")}
                      >
                        Stickerbon openen
                      </button>
                    )}
