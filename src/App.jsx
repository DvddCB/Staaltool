                        ...
                        {dayOrders.map((order) => (
                          <button
                            ...
                            style={{
                              ...
                              background: String(order.status || "").toLowerCase() === "gereed" ? "#16a34a" : "#eab308",
                              color: String(order.status || "").toLowerCase() === "gereed" ? "white" : "#0f172a"
                            }}
          ...
          <>
            ...
            <section style={styles.twoColumn}>
              <div style={styles.pickbonPanel}>
                ...
                {pickbonLines.length > 0 && String(currentSelectedPickerOrder?.status || "").toLowerCase() !== "gereed" && (
                  <div style={allPickbonLinesProcessed ? styles.orderReadyBox : styles.orderReadyBox}>
                    <div>
                      <strong>{allPickbonLinesProcessed ? "Alle regels zijn verwerkt." : "Pickbon afronden"}</strong>
                      <span>{allPickbonLinesProcessed ? " Zet de volledige order nu op verwerkt." : " Klik op verwerken zodra de pickbon klaar is."}</span>
                    </div>
                      ...
                      <div key={line.id} style={line.processed ? styles.pickbonLineDone : styles.pickbonLine} className="pickbon-line-responsive">
                        ...
                        <div style={styles.pickbonLineControls} className="pickbon-controls-responsive">
                          ...
                          {!line.processed && Number(line.scannedQuantity || 0) < Number(line.originalQuantity || line.quantity || 1) && (
                            <button style={styles.smallScanButton} onClick={startScanner}>Scan barcode</button>
                          )}
