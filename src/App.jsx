...
export default function App() {
  ...
  const isAdmin = normalizeRoleValue(userRole) === "admin";
            ...
            <section style={styles.panel}>
              <div style={styles.pickerPanelHeader} className="pickerPanelHeader">
                <div>
                  ...
                  {!isAdmin && (
                    <p style={styles.workerNotice}>{isAdmin ? "Je werkt als beheerder." : isReception ? "Je werkt als receptie." : "Je werkt als gebruiker."} Uploaden, datums wijzigen en verwijderen zijn {isAdmin ? "ingeschakeld" : "uitgeschakeld"}.</p>
                  )}
                </div>
