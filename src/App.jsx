                ...
                {showFinishPrompt && allPickbonLinesProcessed && String(currentSelectedPickerOrder?.status || "").toLowerCase() !== "gereed" && (
                  <div style={styles.confirmOverlay}>
                    <div style={styles.confirmModal}>
                      ...
                      <p style={styles.confirmText}>Alle regels zijn gepickt. Wil je deze pickbon nu verwerken?</p>
                      <div style={styles.confirmActions}>
                        <button style={styles.confirmNoButton} onClick={() => setShowFinishPrompt(false)}>Annuleren</button>
                        <button style={styles.confirmYesButton} onClick={requestFinishOrder}>Verwerken</button>
                      </div>
                    </div>
                  </div>
                )}
