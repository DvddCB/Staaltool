    ...
    <div style={styles.barcodeOuter}>
      <div style={styles.barcodeBars}>
        {bars.map((bar, index) => (
          <div
            key={index}
            style={{ width: bar.width, height: 88, background: bar.space ? "transparent" : "black" }}
          />
        ))}
      </div>
      ...
      <div style={styles.appShell}>
        <header style={styles.header}>
          <div style={styles.brandRow}>
            ...
            <div>
              <h1 style={styles.headerTitle}>Staaltool</h1>
        ...
        {step === "length" && (
          <section style={styles.twoColumn}>
            <div style={styles.panel}>
              ...
              />
              {!lengthIsValid && <div style={styles.warning}>Lengte moet tussen 1000 en 20000 mm liggen en in stappen van 50 mm worden ingevoerd.</div>}
          ...
          <section>
            ...
            <div style={styles.grid}>
              {kleurData.map((color) => (
                <button
                  key={color.code}
                  style={{ ...styles.colorButton, background: color.kleur, color: color.text, border: color.border || "none" }}
        ...
        {step === "result" && (
          <section style={styles.twoColumn}>
            <div style={styles.panel}>
              ...
              <button style={styles.primaryButton} onClick={resetTool}>Nieuwe code maken</button>
            </div>
...
const styles = {
  ...
  loginLogo: { width: "180px", marginBottom: "22px" },
  loginTitle: {
    marginBottom: "24px",
  ...
  loginError: { color: "red", marginTop: "12px" },
  ...
  appShell: { maxWidth: 1180, margin: "0 auto" },
  header: {
    display: "flex",
  ...
  headerLogo: { width: 72, height: "auto" },
  headerTitle: { margin: 0, color: "#1234aa", fontSize: 30, fontFamily: "'Oswald', Arial Black, Impact, sans-serif", letterSpacing: 1 },
  headerSubtitle: { margin: "4px 0 0", color: "#64748b" },
  logoutButton: { border: "none", borderRadius: 12, background: "#ff7a00", color: "white", padding: "10px 14px", fontWeight: 700, cursor: "pointer" },
  steps: { display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 8, marginBottom: 14 },
  step: { background: "rgba(255,255,255,0.78)", color: "#475569", padding: 11, borderRadius: 12, textAlign: "center", fontSize: 14, fontWeight: 700 },
  activeStep: { background: "#1234aa", color: "white", padding: 11, borderRadius: 12, textAlign: "center", fontSize: 14, fontWeight: 700 },
  backButton: { border: "1px solid #cbd5e1", background: "white", borderRadius: 12, padding: "10px 14px", cursor: "pointer", marginBottom: 16 },
  grid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 14 },
  cardButton: { minHeight: 124, background: "white", border: "none", borderRadius: 20, boxShadow: "0 8px 24px rgba(15,23,42,0.10)", cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 18 },
  cardTitle: { fontSize: 26, color: "#1234aa", fontWeight: 900, fontFamily: "'Oswald', Arial Black, Impact, sans-serif" },
  cardText: { marginTop: 6, color: "#64748b" },
  panel: { background: "white", borderRadius: 22, padding: 24, boxShadow: "0 8px 24px rgba(15,23,42,0.10)", marginBottom: 16 },
  sectionTitle: { margin: 0, color: "#1234aa", fontSize: 28 },
  muted: { color: "#64748b" },
  searchInput: { width: "100%", boxSizing: "border-box", border: "1px solid #cbd5e1", borderRadius: 12, padding: 12, fontSize: 16, marginTop: 12 },
  twoColumn: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 18 },
  label: { color: "#64748b", fontSize: 13, textTransform: "uppercase", letterSpacing: 1, fontWeight: 800 },
  bigTitle: { color: "#1234aa", fontSize: 40, margin: "8px 0 20px", fontFamily: "'Oswald', Arial Black, Impact, sans-serif" },
  inputLabel: { display: "block", fontWeight: 800, marginBottom: 8 },
  lengthInput: { width: "100%", boxSizing: "border-box", border: "1px solid #cbd5e1", borderRadius: 14, padding: 14, fontSize: 20 },
  warning: { background: "#fff7ed", color: "#9a3412", padding: 12, borderRadius: 12, marginTop: 12 },
  primaryButton: { marginTop: 14, width: "100%", border: "none", borderRadius: 14, background: "#ff7a00", color: "white", padding: "14px 16px", fontWeight: 800, cursor: "pointer" },
  disabledButton: { marginTop: 14, width: "100%", border: "none", borderRadius: 14, background: "#cbd5e1", color: "#64748b", padding: "14px 16px", fontWeight: 800, cursor: "not-allowed" },
  colorButton: { minHeight: 116, borderRadius: 20, boxShadow: "0 8px 24px rgba(15,23,42,0.12)", cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 18 },
  colorCode: { fontSize: 14, opacity: 0.85, fontWeight: 800 },
  colorName: { fontSize: 24, fontWeight: 900, marginTop: 4, fontFamily: "'Oswald', Arial Black, Impact, sans-serif" },
  summaryLine: { fontSize: 18 },
  resultPanel: { background: "#1234aa", color: "white", borderRadius: 22, padding: 24, boxShadow: "0 8px 24px rgba(15,23,42,0.18)" },
  resultTitle: { marginTop: 0, fontSize: 28, color: "white" },
  resultLabel: { color: "#dbeafe", fontSize: 13, textTransform: "uppercase", letterSpacing: 1, fontWeight: 800, marginTop: 18 },
  articleCode: { background: "rgba(255,255,255,0.14)", padding: 16, borderRadius: 16, fontFamily: "monospace", fontSize: 24, fontWeight: 900, overflowWrap: "anywhere" },
  warningDark: { background: "rgba(255,255,255,0.14)", padding: 14, borderRadius: 14, color: "#fff7ed" },
  barcodeOuter: { background: "white", color: "black", borderRadius: 16, padding: 14 },
  barcodeBars: { height: 88, display: "flex", justifyContent: "center", alignItems: "flex-end", gap: 1, overflow: "hidden" },
  barcodeText: { marginTop: 10, textAlign: "center", fontFamily: "monospace", fontSize: 18, letterSpacing: 1 }
};
