            ...
            <section style={styles.panel}>
              <div style={styles.pickerPanelHeader} className="pickerPanelHeader">
                <div>
                  ...
                  {!isAdmin && (
                    <p style={styles.workerNotice}>{isAdmin ? "Je werkt als beheerder. Uploaden, datums wijzigen en verwijderen zijn ingeschakeld." : isReception ? "Je werkt als receptie. Je kunt alleen pakbon en stickerbon openen." : "Je werkt als gebruiker. Uploaden, datums wijzigen en verwijderen zijn uitgeschakeld."}</p>
                  )}
                </div>
