        ...
        <header style={styles.header} className="app-header-responsive">
          <div style={styles.brandRow} className="app-brand-responsive">
            ...
            <div>
              ...
              <p style={styles.headerSubtitle}>Rol debug: {currentRole || userRole || "-"} · Artikelcodes voor circulaire bouwmaterialen · {isAdmin ? "Beheerder" : isReception ? "Receptie" : "Gebruiker"}</p>
            </div>
          </div>
              ...
              <section style={styles.selectedOrderPanel}>
                ...
                <div style={styles.selectedOrderContent} className="selected-order-responsive">
                  <div>
                    ...
                    {(isAdmin || isReception) && (currentSelectedPickerOrder?.pakbon_url || currentSelectedPickerOrder?.stickerbon_url) && (
                      <div style={styles.pdfButtonRow}>
                        {currentSelectedPickerOrder?.pakbon_url && (
                          <button style={styles.pdfButton} onClick={() => window.open(currentSelectedPickerOrder.pakbon_url, "_blank")}>
                            Pakbon openen
                          </button>
                        )}
                        {currentSelectedPickerOrder?.stickerbon_url && (
                          <button style={styles.pdfButton} onClick={() => window.open(currentSelectedPickerOrder.stickerbon_url, "_blank")}>
                            Stickerbon openen
                          </button>
                        )}
                      </div>
