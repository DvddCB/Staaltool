...
const SUPABASE_URL = import.meta.env.VITE_SUPABASE_URL || "https://wfwrjicbakalyhshtvxa.supabase.co";
const SUPABASE_ANON_KEY = import.meta.env.VITE_SUPABASE_ANON_KEY || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Indmd3JqaWNiYWthbHloc2h0dnhhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzc5ODY0MTksImV4cCI6MjA5MzU2MjQxOX0.4g9uwqCA3OmFr6CK7M_iYEsZlqxXKQlqBYu783Xv9uE";
  ...
  async function handleLogin(event) {
    ...
    try {
      ...
      if (authError) {
        ...
        setError("Login fout: " + (authError.message || "Onbekende Supabase fout"));
        return;
      }
      ...
      console.error(err);
      setError("Login crash: " + (err.message || String(err)));
    }
  }
